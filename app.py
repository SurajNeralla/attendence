...
pwa_html = """
    <link rel="manifest" href="https://raw.githubusercontent.com/SurajNeralla/attendence/main/static/manifest.json">
    <script>
        if ('serviceWorker' in navigator) {
            window.addEventListener('load', function() {
                navigator.serviceWorker.register('https://raw.githubusercontent.com/SurajNeralla/attendence/main/static/sw.js').then(function(registration) {
